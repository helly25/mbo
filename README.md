...
## Additional non C++ components

* bashtest
  * mbo/bashtest:bashtest, mbo/testing/bashtest.sh
  * sh_library `bashtest.sh` which provides a test runner for complex shell tests involving golden files that provides built-in golden update functionality (see `(. mbo/testing/bashtest.sh --help)`).
