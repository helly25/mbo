...
def _fuzz_test_targets(targets):
    """Returns the targets generated by cc_fuzz_test for the given labels."""
    return [target + suffix for target in targets for suffix in [
        "",
        "_bin",
        "_corpus",
        "_oss_fuzz",
