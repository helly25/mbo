 ...
 public:
  ...
  class const_iterator {
   public:
    ...
    const_iterator() noexcept : pos_(nullptr) {}  // Needed for STL
  ...
  class iterator {
   public:
    ...
    iterator() noexcept : pos_(nullptr) {}  // Needed for STL
...
inline constexpr auto MakeLimitedSet(std::initializer_list<Key>&& data, const Compare& key_comp = Compare()) {
  return LimitedSet<Key, N, Compare>(std::forward<std::initializer_list<Key>>(data), key_comp);
}
